...
\subsection{Data PostgreSQL vs. MapD cold}
The diagram \ref{fig:cold_postgres_vs_mapd} compares the query duration of PostgreSQL and MapD at the first time (cold).
